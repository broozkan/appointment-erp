    ...
    if (localStorage.getItem('language') == "tr") {
            ...
            <div className="col-lg-12">
                ...
                <p>
                    <strong>1.1.</strong> Rezervasyonunuzu güvence altına almak için, şirket tarafından aksi kararlaştırılmadıkça, ödemenin tamamı kredi kartınızdan çevrimiçi olarak yapılmalıdır.
                                Tüm sıcak hava balonu uçuşları müsaitlik durumuna bağlıdır. Ödemenizi yapmak için web sitemizi kullanarak rezervasyonda kullanılan kartı sahibinin bu ödemeyi onayladığını kabul ederiz.Satın alma işlemini sonrasında rezervasyon işleminiz Turkey Balloons Cappadocia (ozger.com) onayına sunulur.
                                Turkey Balloons Cappadocia (ozger.com) olarak rezervasyonunuzu onaylama ve iptal etme hakkına sahiptir.Rezervasyonunuz onaylandıktan sonra yetkililerimiz sizinle iletişime geçecektir.
                ...
                <p>
                    <strong>2.1.</strong> Müşteriler planlanan uçuşlar ve turlar için bir gün önce e-posta yoluyla veya telefon bilgilendirilecektir. Seyahat mesafelerinin tahminlerine dayanarak, karşılama süreleri uzman operatörlerimiz tarafından planlanır ve müşterilere iyi niyetle tavsiye edilir.
                                ...
                                Bu tür gecikmeler şirketin makul kontrolünün ötesinde olduğundan, Turkey Balloons Cappadocia (ozger.com) bu koşullarda meydana gelen rahatsızlıklardan sorumlu olmayacaktır.
                                </p>
                ...
                <p>
                    <strong>4.1.</strong>
                                    Turkey Balloons Cappadocia (ozger.com) ’ın para birimi dönüştürücüsü günlük TCBM’nin (Türkiye Cumhuriyet Merkez Bankası) döviz kurlarını kullanır. Çevrimiçi ödemelerde, desteklenen döviz kurları aşağıdaki gibi listelenir:
                                    <br></br>
                                    - Türk Lirası (TL)
                                    <br></br>
                                    - Dolar (USD)
                ...
                <p>
                    <strong>4.3.</strong>
                                    ...
                                    Böyle bir durumda, para birimi dalgalanmaları nedeniyle maruz kaldığınız zararlar için Turkey Balloons Cappadocia (ozger.com) tazminat ödemekle yükümlü değildir.
                                </p>
                <h4>5. İPTAL VE İADE KOŞULLARI</h4>
                <p>
                    <strong>5.1.</strong>
                                    Turkey Balloons Cappadocia (ozger.com), geçerli koşullar uçuş güvenliği için risk oluşturuyorsa, herhangi bir zamanda ön bilgilendirme yapmadan uçuşunuzu iptal etme hakkını saklı tutar.
                ...
                <p>
                    <strong>5.2.</strong>
                                    Uçuşunuzu veya turunuzu gönüllü olarak iptal etmeniz durumunda iptal ücretleri otomatik olarak sizlere yansıtılır. Tam bir geri ödeme almaya hak kazanmak için, planlanan uçuştan en az 4 gün önce rezervasyonunuzu iptal etmeniz gerekir. Uçuşunuzu iptal etmek için iptal talebinizi info@ozger.com adresine e-posta yoluyla göndermelisiniz.
        ...
        saleContractJsx = (
            <div className="col-lg-12">
                ...
                <p>Please read terms and conditions specified below carefully prior to purchasing an air balloon flight with Turkey Balloons Cappadocia (ozger.com) by using our online channel. These terms and conditions apply to all bookings, regardless of the sales channel used. By using our website, you warrant and assert that you are legally eligible to enter in binding contacts and responsible for all payments which incur to you as a result of your booking.</p>
                <h4>1..PAYMENT</h4>
                <p>
                    <strong>1.1.</strong> By using our website to make your payment, we acknowledge that the cardholder used in the reservation has approved this payment.After purchase, your reservation is submitted to Turkey Balloons Cappadocia (ozger.com) approval. Turkey Balloons Cappadocia (ozger.com)  reserves the right to confirm and cancel your reservation.Our officials wills contact you after your reservation is comfimed.If your reservation is not confirmed, it may take 5-10 business for the refund to appear in your credit card book, depending on the processing time of the bank.</p>
                <h4>2. PICK-UP AND DROP-OFF SERVICE</h4>
                <p>
                    <strong>2.1.</strong> Pick up and drop off times are subject to change. Customers will be contacted by email or phone the day before their scheduled flight or tour. Based on estimations of travelling distances, pick-up times are scheduled by our expert operators and advised to customers in good faith. However, sometimes traffic on the route and one-way systems may cause slight delays. Since such delays are beyond the reasonable control of the company, urkey Balloons Cappadocia (ozger.com)  will not be liable for any inconvenience occurred in those circumstances.</p>
                ...
                <p>
                    <strong>4.1.</strong>
                    Turkey Balloons Cappadocia (ozger.com)’s  currency converter uses daily TCBM’s (Central Bank of the Republic of Turkey) exchange rates. For online payments, the supported exchange rates are listed as follows:
                                    <br></br>
                                    - Turkish Lira (TL)
                                    <br></br>
                                    - Dollar (USD)
                ...
                <p>
                    <strong>5.1.</strong>
                    Turkey Balloons Cappadocia (ozger.com)  reserves the right to cancel any flight at any time without further notice if the prevailing conditions constitute risks for flight safety. If your balloon flight or tour is canceled due to unsafe weather conditions expected by us, we offer you 3 options: <br></br>
...
Cancellation charges vary according to the time period in which the voluntary cancellation is made. The table below provides information in respect of cancellation charges:
                ...
                <p>
                    <strong>10.1.</strong>
                    A ticket purchased from Turkey Balloons Cappadocia (ozger.com) for a balloon flight or tours can be operated by another partner balloon or tour operator.
                    </p>
            </div>
        )
    }
